...
export const content = {
  en: {
    ...
    products: {
      ...
      list: [
        "Coffee Cups", "Cold Drink Cups", "Clear Plastic Cups", "Cup Lids", "Cup Sleeves",
        "Paper Bags", "Burger Boxes", "Sandwich Boxes", "Food Containers", "Salad Bowls",
        "Soup Bowls", "Plates", "Pizza Boxes", "Bakery Boxes", "Napkins",
        "Cutlery", "Labels", "Stickers", "Wrapping Paper", "Takeaway Bags",
        "Delivery Packaging", "Tissue Boxes", "Custom Printed Packaging",
      ],
    },
    solutions: {
      eyebrow: "Solutions",
  ...
  ar: {
    ...
    products: {
      ...
      list: [
        "أكواب القهوة", "أكواب المشروبات الباردة", "أكواب بلاستيك شفافة", "أغطية الأكواب", "أغلفة الأكواب",
        "أكياس ورقية", "علب برجر", "علب ساندويتش", "علب طعام", "علب سلطة",
        "علب شوربة", "أطباق", "علب بيتزا", "علب مخابز", "مناديل",
        "أدوات طعام", "ملصقات", "استكرات", "ورق تغليف", "أكياس تيك أواي",
        "تغليف التوصيل", "علب مناديل", "تغليف مطبوع مخصص",
      ],
    },
    solutions: {
      eyebrow: "الحلول",
